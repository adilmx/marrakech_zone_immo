											...
											<li>
												<div class="row gap-10 mt-10">
													...
													<div class="col-xs-5 col-sm-5 text-right">
														<span class="font600 font26 block text-primary mt-5 mx-price" pdays="{{ $car[0]->days_separator }}" pmin="{{ $car[0]->prix_min_per_day }}" pmax="{{ $car[0]->prix_max_per_day }}">{{ $car[0]->prix_min_per_day }}$/1</span><span>{{ __("JOURS") }}</span>
													</div>
												</div>
											</li>
